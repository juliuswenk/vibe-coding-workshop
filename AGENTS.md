...
This repo contains a beginner-facing website for getting started with Vibe Coding.
All changes should help people without coding, Git, or Terminal experience follow the guide safely.
...
- The website is the main learning material. Do not plan a presentation structure unless explicitly requested.

## Target audience

- Readers have probably never worked with Git, GitHub, Terminal, or code before.
...
- Reader-facing content is in English.
...
- Occasionally point out what readers have already accomplished.

## Page structure

- One Markdown file per topic.
- Use short, stable filenames in kebab-case.
- Split pages so readers can quickly find the right place while learning.
...
The structure may be adjusted if that makes the guide easier to use.

## Required structure for each content page

Every reader-facing `.md` file should contain these three orientation parts:
...
2. After that: `## Why this matters for Vibe Coding`
   ...
   - Stay practical: what can readers decide, prepare, or execute better afterward?

3. At the end: `## What you have learned`
   - Briefly summarize what readers can do or understand after this section.
...
- Screenshots or simple visualizations are welcome when they genuinely help readers.
...
- Do not hard-code tooling assumptions in `AGENTS.md`, because recommended tools may change.
- Content must be quickly findable, clearly structured, and not overloaded.
...
- Long presentation material as a replacement for the guide.
